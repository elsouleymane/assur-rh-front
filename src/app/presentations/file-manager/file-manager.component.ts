...
// Get Data
import { fliedata, folder, filerecent, fliefolder, access } from 'src/app/core/data/file-manager';
...
import { fetchData } from 'src/app/store/actions/contact-action';
import { filemanagerModel } from 'src/app/store/models/file-manager.model';
@Component({
